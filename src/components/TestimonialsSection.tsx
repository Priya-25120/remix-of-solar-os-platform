...
const testimonials = [
  {
    ...
    review: "Solar OS helped us increase installations by 45% in just 6 months. We replaced 5 separate tools with one platform — our team has never been more productive.",
    initials: "SM",
  },
  {
    name: "Marcus Chen",
    role: "Sales Manager",
    company: "BrightSolar Arizona",
    review: "The lead tracking alone pays for itself. We're converting 3x more prospects and our close rate went from 18% to 42% within the first quarter.",
    initials: "MC",
  },
  {
    name: "Jessica Rodriguez",
    role: "CEO",
    company: "EcoVolt Florida",
    review: "Finally a platform built for solar. Project scheduling and team coordination features are exactly what we needed to scale from 50 to 200+ installs per month.",
    initials: "JR",
  },
];
